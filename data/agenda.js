...
export const SESSIONS = [
  ...
  },
  {
    ...
    description: "Official opening by the TechFest Sri Lanka 2026 organizing committee and IEEE Sri Lanka Section.",
    type: "ceremony",
    track: "Main Stage",
  ...
  },
  {
    ...
    description: "The top 5 teams from the TechFest Sri Lanka Hackathon present their solutions to a panel of judges from the industry.",
    type: "competition",
    track: "Competition Arena",
    speaker: { name: "5 Finalist Teams", role: "TechFest Sri Lanka Hackathon" },
    featured: true,
  },
  {
    id: 14,
    ...
    description: "Celebrating the achievements of TechFest Sri Lanka 2026 — hackathon winners, outstanding speaker awards, and a closing address.",
    type: "ceremony",
    track: "Main Stage",
